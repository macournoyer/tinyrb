...
SRC = vm/string.c vm/number.c vm/primitive.c vm/array.c vm/hash.c vm/io.c vm/class.c vm/object.c vm/compiler.c vm/grammar.c vm/scanner.c vm/vm.c vm/tr.c
OBJ = ${SRC:.c=.o}
OBJ_MIN = vm/tr.o
